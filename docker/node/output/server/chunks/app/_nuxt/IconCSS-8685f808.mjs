  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--ee54470a": unref(iconUrl)
      } };
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: unref(sSize), height: unref(sSize) }
      }, _attrs, _cssVars))} data-v-ae51ae45></span>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/registry.npmmirror.com+nuxt-icon@0.3.3_vue@3.2.47/node_modules/nuxt-icon/dist/runtime/IconCSS.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ae51ae45"]]);

export { IconCSS as default };
//# sourceMappingURL=IconCSS-8685f808.mjs.map
