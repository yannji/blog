...
import { a as useHead, k as useTagStore, b as useSettingItem, d as __nuxt_component_0$1 } from '../server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full rounded-lg card mx-auto dark:bg-[#202121]" style="${ssrRenderStyle({ "min-height": "590px" })}"${_scopeId}><div class="w-full h-[510px]"${_scopeId}></div><ul class="flex justify-center flex-wrap"${_scopeId}><!--[-->`);
            ssrRenderList(unref(tagsMap), (item, index) => {
            ...
            return [
              createVNode("div", {
                ...
                createVNode("ul", { class: "flex justify-center flex-wrap" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(unref(tagsMap), (item, index) => {
...
//# sourceMappingURL=tags-2db0ca91.mjs.map
